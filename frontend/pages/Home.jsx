        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white border rounded-2xl p-6">
              ...
              <p className="text-gray-600 text-sm">Payez en ligne et retrouvez votre cours au format visio ou présentiel.</p>
            </div>
          </div>
        </div>
      </section>
            ...
            {[1,2,3].map((i) => (
              <div key={i} className="border rounded-2xl p-6 bg-white">
                <div className="flex items-center gap-3 mb-3">
                  <img src={`/avatar-${i}.png`} alt="avatar" className="w-10 h-10 rounded-full object-cover border" />
                  <div>
                    <div className="font-semibold">Utilisateur {i}</div>
                    <div className="text-xs text-amber-600">★★★★★</div>
                  </div>
                </div>
                <p className="text-gray-600 text-sm">
                  “Excellent accompagnement, prof très pédagogue. La plateforme est simple et efficace.”
                </p>
              </div>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-3 gap-10">
          <div className="lg:col-span-2">
            ...
            <details className="border rounded-xl p-4 mb-3">
              ...
              <p className="mt-2 text-gray-600 text-sm">Les tarifs varient selon la matière, le niveau et l'expérience du professeur. En moyenne, comptez entre 15€ et 30€ par heure en Guyane.</p>
            </details>
            <details className="border rounded-xl p-4 mb-3">
              <summary className="cursor-pointer font-semibold">Puis-je avoir un cours en visio ?</summary>
              <p className="mt-2 text-gray-600 text-sm">Oui, de nombreux professeurs proposent des cours en ligne via notre messagerie et des outils de visio intégrés.</p>
            </details>
